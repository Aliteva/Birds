...
@WebServlet(name = "Redact", urlPatterns = {"/Redact"})
@MultipartConfig
public class Redact extends HttpServlet {
    ...
    final String Id = request.getParameter("IdBird");
    System.out.println(Id);
    
    final Part filePart = request.getPart("user_pic");
    Date now = new Date();
    Long dlnow = now.getTime();
    String dnow = dlnow.toString();
    final String fname  =  getFileName(filePart);  
    final String fileName = dnow + fname;
    System.out.println(fileName);
    
    if(fileName.equals(dnow))
    {
        ...
        try
        {
            ...
            stat.executeUpdate("DELETE FROM bird_region WHERE Id_bird=" + Id);
                        
            stat.executeUpdate("UPDATE birds SET Name='" + name + "', IntName='" + intname + "', Squard='" + otr + "', Family='" + fam + "', Kind='" + kind + "'  WHERE Id='" + Id + "'");
    ...
    try {
        ...
        try
        {
            ...
            Statement stat = conn.createStatement();
            stat.executeUpdate("DELETE FROM bird_region WHERE Id_bird=" + Id);
            stat.executeUpdate("DELETE FROM birds WHERE Id=" + Id);
