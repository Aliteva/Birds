...
public class Delete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] birdsStay = request.getParameterValues("b");
        ...
        try
        {
            ...
            for(int i=0;i<birdsStay.length;++i){
                stat.executeUpdate("DELETE FROM bird_region WHERE Id_bird='" + birdsStay[i] + "'");
                stat.executeUpdate("DELETE FROM birds WHERE Id='" + birdsStay[i] + "'");
